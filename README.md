...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ensaio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14879&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ensaio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ensaio` can be installed with:

```
conda install ensaio
```

It is possible to list all of the versions of `ensaio` available on your platform with:
